...
fn configure_bindgen() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .clang_args(["-x", "c++", "--target=x86_64-linux-android26", "--sysroot=D:/SOFTWARES/01_ANDROID_SDK_HOME/ndk/26.3.11579264/toolchains/llvm/prebuilt/windows-x86_64/sysroot", "-ID:/PROJECT/_TRASH/REDROID/local-setup/build/ksud-x86_64", "-ID:/SOFTWARES/01_ANDROID_SDK_HOME/ndk/26.3.11579264/toolchains/llvm/prebuilt/windows-x86_64/sysroot/usr/include", "-ID:/SOFTWARES/01_ANDROID_SDK_HOME/ndk/26.3.11579264/toolchains/llvm/prebuilt/windows-x86_64/sysroot/usr/include/x86_64-linux-android"])
